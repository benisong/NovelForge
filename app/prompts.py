...
**身体局部微动作特写（新一代 AI 重灾区，最需警惕）**：不要用"指关节发白/指节泛白/指尖微微颤抖/喉结滚动/喉头发紧/屏住呼吸/呼吸一滞/心跳漏了一拍/瞳孔骤缩/太阳穴跳动/血色褪去/咬着下唇/抵着下唇/舔了舔嘴唇"这类标准身体反应库。
**看起来很"具体"，本质仍是 AI 陈词，只是换了层皮**。真正的人味是情绪从**无关的生活动作**里漏出来，不是把情绪翻译成某一条标准身体反应。

**情绪直接命名**：不要写"她感到愤怒/悲伤/迷茫"。正确的外化方向：
- 好：她没回答，继续把芒果皮撕成条。
- 好：她看了一眼手机，屏幕是暗的。
- 好：他抽完那根烟，才说"再说吧"。
- 坏（AI 陈词）：她指关节发白 / 她咬着下唇 / 她瞳孔骤缩
...
- **身体局部微动作特写陈词（新一代 AI 重灾区，直接 high 级扣分）**：
  指关节发白 / 指节泛白 / 指尖微微颤抖 / 指尖轻颤 / 无意识摩挲 / 拇指反复摩擦（某物）/
  喉结滚动 / 喉头发紧 / 屏住呼吸 / 呼吸一滞 / 呼吸一窒 / 心跳漏了一拍 / 心脏漏跳 /
  瞳孔骤缩 / 瞳孔微缩 / 眼尾泛红 / 太阳穴跳动 / 血色褪去 / 脸色煞白 /
  咬着下唇 / 抵着下唇 / 舔了舔嘴唇 / 牙关紧咬 / 下颌线紧绷 / 肩膀一颤。
  这类"具体到关节 / 器官 / 局部肌肉"的微反应，已是网文与大模型共同形成的新套路，
  **看似具体实则陈词**。一旦出现，出一条 high 级 item；若整章出现 ≥3 处，另加一条总评式
  high item（"身体微反应陈词密度过高"）。
